...
this.attr("HTTPStatusCode", "hTTPStatusCodeAttr", "HTTPStatusCode", false, false, OS.Types.Integer, function () {
return 0;
}, true)
].concat(_super.attributesToDeclare.call(this));
};
...
return [
this.attr("DatabaseName", "databaseNameAttr", "DatabaseName", false, false, OS.Types.Text, function () {
return "";
}, true), 
this.attr("LogicalDatabaseName", "logicalDatabaseNameAttr", "LogicalDatabaseName", false, false, OS.Types.Text, function () {
return "";
}, true)
].concat(_super.attributesToDeclare.call(this));
};
