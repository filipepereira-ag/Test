...
install_xcframework "${PODS_ROOT}/AgentifaiAssistant/AgentifaiCoreNotifications.xcframework" "AgentifaiAssistant/AgentifaiCoreNotifications" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
...
install_xcframework "${PODS_ROOT}/AgentifaiAssistant/AgentifaiFeatureSelector.xcframework" "AgentifaiAssistant/AgentifaiFeatureSelector" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
